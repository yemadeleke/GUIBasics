...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->textBox1->Size = System::Drawing::Size(152, 40);
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 21.75F, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Italic)),
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->textBox2->Location = System::Drawing::Point(300, 27);
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(152, 40);
			...
			this->button2->Location = System::Drawing::Point(204, 114);
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 21.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button3->Location = System::Drawing::Point(204, 161);
			...
			this->button4->Location = System::Drawing::Point(204, 208);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 21.75F, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Italic)),
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(322, 91);
...
#pragma endregion
    ...
    private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		//int output = textBox1->Text + textBox2->Text;               //->arrow pointer. This is just text, need to convert to int.
		int output = System::Convert::ToInt16(textBox1->Text) + System::Convert::ToInt16(textBox2->Text);   //Note float to handle division
    ...
    private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		label2->Text = System::Convert::ToString(output);                //This is the ouput display
    }

		   //Subtraction
    private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	    //int output = textBox1->Text x textBox2->Text;               //->arrow pointer. This is just text, need to convert to int as in next line.
	    Decimal output = System::Convert::ToDecimal(textBox1->Text) * System::Convert::ToDecimal(textBox2->Text);
	...
	//int output = textBox1->Text + textBox2->Text;               //->arrow pointer. This is just text, need to convert to Decimal for division.
	    Decimal output = System::Convert::ToDecimal(textBox1->Text) / System::Convert::ToDecimal(textBox2->Text);
